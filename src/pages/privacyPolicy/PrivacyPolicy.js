...
function PrivacyPolicy(props) {
  return (
    <div className="privacy-policy">
      <h1>Privacy Policy for Checkpoint</h1>

      <p>
        At Checkpoint, accessible from checkpoint.tokyo, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by Checkpoint and how we
        use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in Checkpoint. This policy is not applicable to any
      ...
      <p>
        Checkpoint follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Checkpoint.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Checkpoint, which are sent directly to users'
      ...
      <p>
        Note that Checkpoint has no access to or control over these cookies that are used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>

      <p>
        Checkpoint's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>
        Checkpoint does not knowingly collect any Personal Identifiable Information from children under the age of 13.
