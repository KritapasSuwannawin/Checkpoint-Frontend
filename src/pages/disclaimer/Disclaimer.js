...
function Disclaimer(props) {
  return (
    <div className="disclaimer">
      <h1> Disclaimer for Checkpoint</h1>

      <p>
        If you require any more information or have any questions about our site's disclaimer, please feel free to
        contact us by email at phuriphan@checkpoint.tokyo. Our Disclaimer was generated with the help of the{' '}
        <a href="https://www.disclaimergenerator.net/">Disclaimer Generator</a>.
      </p>

      <h2>Disclaimers for Checkpoint</h2>

      <p>
        All the information on this website - checkpoint.tokyo - is published in good faith and for general information
        purpose only. Checkpoint does not make any warranties about the completeness, reliability and accuracy of this
        information. Any action you take upon the information you find on this website (Checkpoint), is strictly at your
        own risk. Checkpoint will not be liable for any losses and/or damages in connection with the use of our website.
      </p>
      ...
      <p>
        ...
        sites. Site owners and content may change without notice and may occur before we have the opportunity to remove
